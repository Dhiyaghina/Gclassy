...
<head>
    ...
    <title>@yield('title') - Sistem E-Learning Guru</title>
                    ...
                    <div class="flex">
                        <div class="flex flex-shrink-0 items-center">
                            ...
                            <a href="{{ route('teacher.classes.index') }}" 
                               class="{{ request()->routeIs('teacher.classes.*') ? 'border-blue-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' }} inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium">
                                Kelas Saya
                            </a>
                        </div>
                    </div>
